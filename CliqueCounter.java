...
//		Reduce2: <(xi,xj),{u1,...uk}> ---> <(xi,xj),{u1,...,uk} U $}> se e solo se (xi,xj) è effettivamente un arco
...
//		Eliminiamo il $, dato che ha esaurito la sua funzione
...
//      _____FINE ROUND 3_______
		...
		double minutes = (double)estimatedTime/60000;
